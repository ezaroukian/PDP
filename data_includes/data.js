...
var items = [
	...
	["endSurvey","Message", {html: '<h3>Thank you for your participation!</h3><p>This study was designed to assess how quickly and accurately human users respond to statements in plain English (e.g. "John sees a letter") versus a restricted computer-readable form of English (e.g. "The person John sees the letter l1"). Your responses will help us design computer-readable languages that can still be quickly and accurately understood by human users.</p><center><p>Your code is:</p><b>'+code.toString()+'</b></center><p>Be sure to enter this code on the Amazon Mechanical Turk site so that you can be rewarded for completing this HIT.</p>', 
							transfer: null }
	],
